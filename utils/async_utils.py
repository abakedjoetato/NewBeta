...
from typing import Dict, List, Optional, Any, Union, Set, Tuple, TypeVar, Callable, Coroutine
...
class AsyncCache:
    ...
    def invalidate_pattern(cls, func: Callable, pattern_args: List[Any]) -> int:
        ...
        for cache_key in cls._cache[func_name]:
            # Check if key args match pattern
...
async def semaphore_gather(semaphore: asyncio.Semaphore, coros: List[Coroutine]) -> List[T]:
